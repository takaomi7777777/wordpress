...
if (have_posts()) :
	...
	if ($options['top_post_show_type'] == 'normal' || $options['top_post_show_type'] == 'gallery') : 
...
<section id="post-table-section" class="clearfix">
	<?php if ($options['top_posts_table_title']) : ?>
...
<div class="nav_to_paged"><?php next_posts_link($options['navigation_text_to_2page']) ?></div>
<?php 
